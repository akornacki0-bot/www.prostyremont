...
- Zdjęcia i logo pochodzą z materiałów właściciela. `assets/web` to zoptymalizowane pliki WebP, fotografie realizacji wyodrębnione z „PROSTA OFERTA.pdf”. Bez generowania nowych realizacji.
